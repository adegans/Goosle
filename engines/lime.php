...
---------------------------------------------------------------------------------------
Name: limetorrents.lol
Description: Movies, tv-shows, books, software, games and more.
...
class LimeRequest extends EngineRequest {
	public function get_request_url() {
		$query = preg_replace('/[^a-z0-9- ]/', '', strtolower($this->search->query_urlsafe));
	...
	public function parse_results($response) {
		...
		// If we have something to include, include it with the other engines
